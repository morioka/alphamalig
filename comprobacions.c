#include "align.h"
                                  ...
                                  void comprovarlecturaalfabet(){
                                    ...
                                    for (i=1;i<=numsimb;i++) printf("%c ",alfabet[i]);
                                    printf("\n");
                                  ...
                                  void comprovar_similitud(char *seq1,char *seq2, long longseq1,long longseq2){
                                    ...
                                    while((i>0)||(j>0)){
                                      ...
                                      if (matriu_cami[i][j]=='a'){
                                        ...
                                        alin0[pos]=seq1[i-1];alin1[pos]=seq2[j-1];
                                        i--;j--;
                                      }
                                      else{
                                        alin1[pos]=seq2[j-1];alin0[pos]='-';
                                        j--;
                                      }
                                    ...
                                    i=pos-1;
                                    while (i>80){
                                      for (j=0;j<80;j++)   printf("%c",alin0[i-j]);
                                      printf("\n");
                                      for (j=0;j<80;j++)   printf("%c",alin1[i-j]);
                                      i=i-80;printf("\n\n");
                                    }
                                    for (j=i;j>=0;j--) printf("%c",alin0[j]);
                                    printf("\n");
                                    for(j=i;j>=0;j--) printf("%c",alin1[j]);        
                                  ...
                                  void comprovar_carregar_sequencia(char *seq,long longseq){
                                    ...
                                    for (i=0;i<longseq;i++) printf("%c",seq[i]);
                                    printf("\n");
                                  }
                                  ...
                                  void comprova_matriu_cami(float **mat,int l1,int l2){
                                    ...
                                    printf("l1=%d,l2=%d\n",l1,l2);
                                    for (i=0;i<=l1;i++){
                                      for(j=0;j<=l2;j++) printf("%c,",matriu_cami[i][j]);
                                      for(j=0;j<=l2;j++) printf("%f,",mat[i][j]);
                                      printf("\n");
                                    }
                                  }
