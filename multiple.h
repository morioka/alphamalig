...
void alignment_clusters(float **matrix, int i, int j, float **info1, float **info2, char *linia_orig, char *linia_desti, char *resultat_cluster1, char *resultat_cluster2, long *puntuacio);
long add_sequence_cluster(FILE *fitxer, int num_seq);
void create_cluster_files(int i, int j);
void similarity_clusters(float **matrix, long long_cluster1, long long_cluster2, float **info1, float **info2, long *puntuacio,
                        int, int);
void build_info_cluster(int num_cluster, float **info, FILE *f);
void align_clusters(int i, int j, char *res1, char *res2, int *len);
void rebuild_new_cluster(char *linia_orig, char *linia_desti, char *resultat_cluster1, char *resultat_cluster2, int i, int j,
                             int len);
